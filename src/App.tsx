...
const App: React.FC = () => {
  ...
  const onAcceptCookies = () => {
    // @ts-ignore
    window[`ga-disable-${process.env.REACT_APP_GOOGLE_ANALYTICS_ID || 'G-945BK09GDC'}`] = false;
  ...
  const onDeclineCookies = (args?: {skipGAEvent?: boolean}) => {
    ...
    // @ts-ignore
    window[`ga-disable-${process.env.REACT_APP_GOOGLE_ANALYTICS_ID || 'G-945BK09GDC'}`] = true;
