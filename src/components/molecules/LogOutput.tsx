...
import type {Coordinates} from '@models/config';
...
import {FullscreenLogOutput} from './LogOutput/FullscreenLogOutput';
import {LogOutputPure} from './LogOutput/LogOutputPure';
import {useCountLines, useLastLines} from './LogOutput/utils';
...
export const LogOutput: FC<LogOutputProps> = memo(props => {
