...
import type {Entity, EntityArray} from '@models/entityMap';
import type {FilterProps} from '@models/filters';

import {FilterMenuFooter} from '@molecules/FilterMenu/FilterMenuFooter';
import {StyledFilterDropdown, StyledFilterLabel, StyledFilterMenu} from '@molecules/FilterMenu/MenuFilter.styled';
...
export const LabelsFilter: FC<FilterProps> = props => {
