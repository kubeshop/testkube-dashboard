...
import {EmptyExecutionsListContent} from './ExecutionsTable/EmptyExecutionsListContent';
import {TableRow} from './ExecutionsTable/TableRow';
...
export const ExecutionsTable: FC<ExecutionsTableProps> = ({onRun, useAbortExecution}) => {
