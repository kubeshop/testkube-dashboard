...
export const executorsList: ExecutorGridItem[] = [
  {
    ...
    docLink: 'https://docs.testkube.io/test-types/executor-cypress/',
  },
  {
    type: 'postman/collection',
    title: 'Postman',
    description: 'Run tests from Postman definitions. Easy to define and collaborate across your team.',
    docLink: 'https://docs.testkube.io/test-types/executor-postman/',
  },
  {
    type: 'custom',
  ...
  },
  {
    ...
    docLink: 'https://docs.testkube.io/test-types/executor-artillery/',
  },
  {
    type: 'kubepug/yaml',
    title: 'KubePug',
    description: 'Kubernetes Pre UpGrade (Checker) checks whether your objects are deprecated before migrating. ',
    docLink: 'https://docs.testkube.io/test-types/executor-kubepug/',
  },
  {
    type: 'maven/test',
    title: 'Maven',
    ...
    docLink: 'https://docs.testkube.io/test-types/executor-maven/',
  },
  {
    type: 'gradle/test',
    title: 'Gradle',
    ...
    docLink: 'https://docs.testkube.io/test-types/executor-gradle/',
  },
  {
    type: 'ginkgo/test',
    title: 'Ginkgo',
    ...
    docLink: 'https://docs.testkube.io/test-types/executor-ginkgo/',
  },
  {
    type: 'jmeter/test',
    title: 'JMeter',
    ...
    docLink: 'https://docs.testkube.io/test-types/executor-jmeter',
  },
];
