...
import type {LocalStep, TestSuite} from '@models/testSuite';

import {InlineNotification} from '@molecules/InlineNotification';
...
import {DelayModal} from './SettingsTests/Modals/DelayModal';
import {TestModal} from './SettingsTests/Modals/TestModal';
import {TestSuiteStepsFlow} from './SettingsTests/TestSuiteStepsFlow';

export const SettingsTests = memo(() => {
