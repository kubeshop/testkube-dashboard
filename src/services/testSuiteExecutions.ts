...
// Apply optimization
testSuiteExecutionsApi.useGetTestSuiteExecutionsByTestIdQuery = memoizeQuery(testSuiteExecutionsApi.useGetTestSuiteExecutionsByTestIdQuery, (executions) => (
...
testSuiteExecutionsApi.useGetTestSuiteExecutionByIdQuery = memoizeQuery(testSuiteExecutionsApi.useGetTestSuiteExecutionByIdQuery);
testSuiteExecutionsApi.useGetTestSuiteExecutionMetricsQuery = memoizeQuery(testSuiteExecutionsApi.useGetTestSuiteExecutionMetricsQuery, (metrics) => (
  // Limit to show maximum of 1000 latest executions
